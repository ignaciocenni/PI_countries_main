...
export default function FormPage(){
    ...
    return(
        <div className={s.prindiv}>
            <div className={s.bar}>
            <Link to= "/home"><img className={s.bothome} onClick={(event) => handleClick(event)} src={logo} alt="logo"></img></Link>
            </div>
            ...
            <form onSubmit={(event)=> handleSubmit(event)}>
                ...
                <div>
                    ...
                    <select className={s.inputs} name="countries" id="countries" onChange={(e) => handleSelect(e)}>
                        ...
                        {countries.sort((a, b) => a.name.localeCompare(b.name)).map((con) => (
                ...
                {input.countries.map(e =>
                    <div key={e.id}className={s.conpais}>
